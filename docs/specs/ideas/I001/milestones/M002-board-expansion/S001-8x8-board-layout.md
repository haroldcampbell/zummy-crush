...
- Reference `docs/ideas/I001/design-baseline.md` for tile sizing and spacing
...
- Target baseline viewport: 360x640 (see `docs/ideas/I001/design-baseline.md`)
...
- Config location: `app/ideas/I001/assets/config/gameplay.json`
