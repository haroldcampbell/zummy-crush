...
- Canonical mode marker: `logs/work-mode.md`.
...
1. Confirm `logs/work-mode.md` is set to `mode: multi`.
...
5. Re-check `specs/milestones.md` and the milestone spec folder to confirm availability.
...
10. Write a session hand-off in `hand-offs/` before opening the PR.
