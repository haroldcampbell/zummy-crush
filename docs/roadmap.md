...
- [x] M001 - Golden Demo
  - Specs: `docs/specs/milestones/M001-golden-demo/`

- [ ] M002 - Core Board Expansion (8x8 + voids)
  - Specs: `docs/specs/milestones/M002-board-expansion/`
  - Planned: S004 Gravity + Repulsion Feel Experiment

- [ ] M003 - Match-4 Slice (Power-Up + Loot + Micro-Reward)
  - Specs: `docs/specs/milestones/M003-powerups-v1/`
...
- [ ] M006 - Power-Up Activation Slice + Micro-Reward
  - Specs: `docs/specs/milestones/M006-powerup-activation/`

- [ ] M007 - Loot Gallery Slice
  - Specs: `docs/specs/milestones/M007-loot-gallery/`
